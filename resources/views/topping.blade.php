<x-guest-layout>
    ...
    <div class="ml-64 shrink">
        ...
        <div class="col-span-10 p-10">
            <div class="text-primary text-xl tracking-wider">Topping</div>
            <div class="text-2xl font-bold text-primary mb-8">Tambahkan topping yang Anda sukai</div>
            ...
            <div class="grid grid-cols-12">
                <div class="col-span-4 mr-8">
                    <div class="block">
                        <img class="h-96 w-full object-cover rounded-2xl"
                ...
                <div class="col-span-8">
                    ...
                    <div class="mt-2 bg-white shadow-lg rounded-xl p-4">
                        ...
                        <div class="hidden">
                            <x-input id="bubur_id" class="block mt-2 w-full" type="text" name="bubur_id"
                                value="{{ $menu->id }}" />
