<div class="fixed w-64 h-screen bg-secondary">
    <div class="overflow-y-auto py-4 px-3 h-full">
        ...
        <ul class="space-y-2">
            ...
            <li>
                <x-nav-link :href="route('admin.history-order-topping')" :active="request()->getRequestUri() == '/admin/history-order-topping'">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-egg-fried h-5 w-5 ml-2"
                        viewBox="0 0 16 16">
