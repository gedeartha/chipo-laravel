            ...
            <div class="grid grid-cols-12 gap-10">
                <div class="col-span-8">
                    <div class="shadow-md bg-white rounded-xl p-5">
                        <div class="font-extrabold text-3xl text-primary mb-4">Tambah Topping</div>
                        <hr class="mb-4" />
                        ...
                        <form method="POST" action="{{ route('admin.topping.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <x-input id="name" class="block mt-2 w-full" type="text" name="name"
                                    placeholder="Masukkan nama topping" required autofocus />
