            ...
            <div class="grid grid-cols-12 gap-10">
                <div class="col-span-8">
                    <div class="shadow-md bg-white rounded-xl p-5">
                        <div class="font-extrabold text-3xl text-primary mb-4">Edit Admin</div>
                        <hr class="mb-4" />
                        ...
                        <form method="POST" action="{{ $admin->id }}/update" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
